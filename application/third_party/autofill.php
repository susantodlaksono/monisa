 ...
 * @property M_group             $m_group
 * @property M_menu              $m_menu
 * @property M_security          $m_security
 * @property M_user              $m_user
 * @property M_renstra           $m_renstra
 * @property M_renstra_category  $m_renstra_category
 * @property M_renstra_data      $m_renstra_data
 * @property Renstra_model       $renstra_model
 */
class CI_Controller {
